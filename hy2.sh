...
DEFAULT_PORT=29999         # 自适应端口
AUTH_PASSWORD="Ap746xVZkQ3n7adCYaQq6"   # 建议修改为复杂密码
CERT_FILE="cert.pem"
KEY_FILE="key.pem"
SNI="www.bing.com"
ALPN="h3"
...
print_connection_info() {
    ...
    echo "hysteria2://${AUTH_PASSWORD}@${IP}:${SERVER_PORT}?sni=${SNI}&alpn=${ALPN}&insecure=1#Hy2-chow"
    echo ""
    echo "📄 客户端配置文件:"
